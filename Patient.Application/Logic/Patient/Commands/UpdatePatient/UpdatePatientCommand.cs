...
{
    public class UpdatePatientCommand : IRequest<Guid>, IMapTo<Domain.Entities.Patient>
    {
        [JsonIgnore]
        public Guid Id
        {
        ...
        {
            profile.CreateMap<UpdatePatientCommand, Domain.Entities.Patient>()
                ...
                .ForMember(d => d.HasActive, opt => opt.MapFrom(s => s.Active));
        }
    }
}
